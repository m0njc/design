...
<div class="super_container">
  ...
  <div class="main_slider" style="background-image:url(<?php echo base_url()?>/templates/images/banner.jpg)">
  ...
  <div class="video">
    <video id="v" controls>
        <source id='mp4'
        src="<?php echo base_url()?>/templates/video/video.mp4"
        type='video/mp4'>
        <p>Your user agent does not support the HTML5 Video element.</p>
    </video>
  <div id="overlay"></div>
    <div class="overlay">
        <p>The Story Behind jnr.specs</p>
    </div>
</div>
  ...
  <div class="photo-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-9">
          <img src="<?php echo base_url()?>/templates/images/headshot/square1.jpg" alt="">
          <img src="<?php echo base_url()?>/templates/images/headshot/square2.jpg" alt="">
          <img src="<?php echo base_url()?>/templates/images/headshot/square1.jpg" alt="">
          <img src="<?php echo base_url()?>/templates/images/headshot/square2.jpg" alt="">
        </div>
      </div>
